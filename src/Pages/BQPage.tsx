    ...
    <div className="Bbody">
      ...
      <div className="ProgressBarBQ">
        <div
          ...
          style={{ width: `${(currentQuestionIndex + 1) * 4}%` }}
        ></div>
      </div>
      <p className="BQB">
      ...
      <div className="BQQuestions">
        <h2>
          Question {currentQuestionIndex + 1} of {questions2.length}
        </h2>
        <div
          key={questions2[currentQuestionIndex].question}
          className="question-con"
        >
        ...
        <button
          ...
          disabled={currentQuestionIndex === questions2.length - 1}
        >
          Next
        </button>
      </div>
