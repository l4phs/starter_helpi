      ...
      <div className="Hbody">
        ...
        <div className="BQDiscriptions">
          ...
          <p className="BQDiscriptionBox">
            ...
            Tailored for those beginning their career journey, this quiz helps
            you explore your interests, strengths, and preferences. Quick and
            easy to understand and results are immediate following the
            completion of the quiz. Uncover potential career paths aligned with
            your aspirations, whether you're a recent graduate or considering a
            change. Start your exploration today and take the first step toward
            a fulfilling career!
          </p>
